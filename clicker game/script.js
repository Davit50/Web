...
function buyWorker(){
  if(userMoney < workerCost){
    alert("You dont have enough for a worker You have $" + userMoney + " you need $" + workerCost+".");
    return;
  }
...
function buyFactory(){
  if(userMoney < factoryCost){
    alert("You dont have enough for a factory. You have $" + userMoney + " you need $" + factoryCost+".");
    return;
  }
...
function buyKilofactory(){
  if(userMoney < kilofactoryCost){
    alert("You dont have enough for a kilofactory. You have $" + userMoney + " you need $" + kilofactoryCost+".");
    return;
  }
...
function buyMegafactory(){
  if(userMoney < megafactoryCost){
    alert("You dont have enough for a megafactory. You have $"+ userMoney + " you need $" + megafactoryCost+".");
    return;
  }
...
function buyNosecone(){
  if(userMoney < 1000000){
    alert("You dont have enough for a Nose Cone. You have "+ userMoney + " you need 1000000.");
    return;
  }
  if(nosecone){
...
function buyCockpit(){
  if(userMoney < 1500000){
    alert("You dont have enough for a Cockpit. You have "+ userMoney + " you need 1500000.");
    return;
  }
  if(cockpit){
...
function buyFuel(){
  if(userMoney < 2000000){
    alert("You dont have enough for Fuel. You have "+ userMoney + " you need 2000000.");
    return;
  }
    if(fuel){
...
function buyFrame(){
  if(userMoney < 2500000){
    alert("You dont have enough for a Frame. You have "+ userMoney + " you need 2500000.");
    return;
  }
    if(frame){
...
function buyOxidizer(){
  if(userMoney < 3000000){
    alert("You dont have enough for an Oxidizer. You have "+ userMoney+" you need 3000000.");
    return;
  }
    if(oxidizer){
...
function buyPumps(){
  if(userMoney < 3500000){
    alert("You dont have enough for Pumps. You have "+ userMoney + " you need 3500000.");
    return;
  }
    if(pumps){
...
function buyNozzle(){
  if(userMoney < 4000000){
    alert("You dont have enough for a Nozzle. You have "+ userMoney + " you need 4000000.");
    return;
  }
    if(nozzle){
...
function buyFins(){
  if(userMoney < 4500000){
    alert("You dont have enough for Fins. You have "+ userMoney + " you need 4500000.");
    return;
  }
    if(fins){
...
function totalProduction(){
  ...
  var kilofactoryProduction = parseInt(document.getElementById("kilofactoryProduction").innerHTML);
  var megafactoryProduction = parseInt(document.getElementById("megafactoryProduction").innerHTML);
